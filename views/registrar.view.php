                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <label class="form-control">
                            ...
                            <input name="nome" type="text" class="input input-neutral input-bordered w-full max-w-xs bg-white" value="<?= old('nome') ?>" />
                        ...
                        <label class="form-control">
                            ...
                            <input name="email" type="text" class="input input-neutral input-bordered w-full max-w-xs bg-white" value="<?= old('email') ?>" />
                        ...
                        <label class="form-control">
                            ...
                            <input name="email_confirmacao" type="text" class="input input-neutral input-bordered w-full max-w-xs bg-white" />
                        </label>
                        ...
                        <label class="form-control">
                            ...
                            <input name="senha" type="password" class="input input-neutral input-bordered w-full max-w-xs bg-white" />
